...
!function (t, e) { "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.AirflexJS = e() : t.AirflexJS = e(); }(self, (() => (() => { var t = { 3145: (t, e) => {
    ...
    "use strict";
    n.r(r), n.d(r, { create: () => ii, createDeepLink: () => ni, createShortLink: () => ri, default: () => ai, getDeviceId: () => Kr, logEvent: () => Qr, pushAds: () => oi, setPageView: () => $r, setUserId: () => ei, setUserProperties: () => ti });
    var t = {};
    ...
    function Vr() {
        return __awaiter(this, void 0, void 0, function* () { var _b, _d; const t = yield (() => __awaiter(this, void 0, void 0, function* () { var _b; let t; const e = `${I() ? j : O}/js-sdk/config/chatbot-config`, n = { method: "GET", headers: { "Content-Type": "application/json", Authorization: `${sessionStorage.getItem(s)}` } }, r = yield fetch(e, n); return t = (_b = (yield r.json())) === null || _b === void 0 ? void 0 : _b.data, t; }))(); if (!t)
            ...
            const n = io(t.socketApi, { path: "/chatbot", reconnectionAttempts: 3 }), i = Kr();
    ...
    const Zr = Hr, Jr = (_b) => __awaiter(void 0, [_b], void 0, function* ({ ad_id: t, action: e, element_id: n }) { let r; const i = { method: "POST", headers: { "Content-Type": "application/json", Authorization: `${sessionStorage.getItem("__session_token_af__")}` }, body: JSON.stringify({ ad_id: t, action: e, element_id: n }) }; try {
    ...
    function Gr() {
        return __awaiter(this, void 0, void 0, function* () { document.querySelectorAll(".adsbyairflex").forEach(((t) => __awaiter(this, void 0, void 0, function* () { var _b; if (t.dataset.loaded)
            ...
            try {
                const r = yield ((_b) => __awaiter(this, [_b], void 0, function* ({ ad_id: t, ad_type: e }) { let n; const r = { method: "POST", headers: { "Content-Type": "application/json", Authorization: `${sessionStorage.getItem("__session_token_af__")}` }, body: JSON.stringify({ ad_id: t, ad_type: e }) }; try {
    ...
    let qr, Yr = "", Xr = !1;
    const $r = (t_1, ...args_1) => __awaiter(void 0, [t_1, ...args_1], void 0, function* (t, e = {}) { ke(t, e); }), Kr = () => qr, Qr = (t_1, ...args_1) => __awaiter(void 0, [t_1, ...args_1], void 0, function* (t, e = {}) { Fe(t, e); }), ti = (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (t = {}) { Nr(t); }), ei = (t) => __awaiter(void 0, void 0, void 0, function* () { Nr({ user_id: (t !== null && t !== void 0 ? t : "") + "" }); }), ni = (t) => __awaiter(void 0, void 0, void 0, function* () { let e = new Zr; e.setProperties(t); let n = e.checkRequiredParams(); return "" != n ? { responseCode: "400", responseMessage: "Required parameter: " + n } : yield ((t) => __awaiter(void 0, void 0, void 0, function* () { return yield (t => (sessionStorage.getItem("token"), Ge({ url: "/js-sdk/deeplink/create", data: t, apiName: "apiCreateDeeplink" })))(t); }))({ fields: e.buildParams() }); }), ri = (t_1, ...args_1) => __awaiter(void 0, [t_1, ...args_1], void 0, function* (t, e = "", n = "") { return "" == t || null == t || 0 == t.startsWith("http") ? { responseCode: "400", responseMessage: "Long link is required" } : yield ((t) => __awaiter(void 0, void 0, void 0, function* () { return yield (t => (sessionStorage.getItem("token"), Ge({ url: "/js-sdk/deeplink/shorten-link", data: t, apiName: "apiCreateShortLink" })))(t); }))({ name: e, short_link_id: n, redirect_url: t }); }), ii = (t_1, ...args_1) => __awaiter(void 0, [t_1, ...args_1], void 0, function* (t, e = {}) { var _b; Yr = t, 1 == e.devmode && ((t = !1) => { E = t; })(!0), qr = yield Er(), yield Ve(Yr), Xr || ((_b = window === null || window === void 0 ? void 0 : window.history) === null || _b === void 0 ? void 0 : _b.pushState({}, null, null), Xr = !0), (() => __awaiter(void 0, void 0, void 0, function* () { const t = Object.assign(Object.assign(Object.assign({}, yield Lr()), yield Rr()), { asdki: yield Er() }); if (Tr(t), sessionStorage.getItem(d)) {
        ...
        return; let n = 0, r = !1; document.addEventListener("scroll", (t => { r || null == window || (n = window === null || window === void 0 ? void 0 : window.scrollY, setTimeout((() => { Qr("lid_mmp_scroll", { lastKnownScrollPosition: n }), r = !1; }), 1e3), r = !0); })), e.addEventListener("keydown", (function (t) { Qr("lid_mmp_keypress", { key: t.key }); })), document.addEventListener("click", (t => { let e = t.clientX, n = t.clientY; Qr("lid_mmp_click", { click_x: e, click_y: n }); })), document.getElementsByTagName("body")[0].addEventListener("mousemove", (t => { Mr(); })), document.getElementsByTagName("body")[0].addEventListener("click", (t => { setTimeout((() => { Mr(); }), 300); })); })(document), Vr(), setTimeout((() => { document.dispatchEvent(new CustomEvent("AirflexOnReady", { detail: { message: "Airflex is initialized", timestamp: new Date } })); }), 500); }), oi = () => { let t = setInterval((() => { if (Ue)
        return Gr(), void clearInterval(t); }), 1e3); }, ai = { create: ii, logEvent: Qr, setUserProperties: ti, setUserId: ei, setPageView: $r, getDeviceId: Kr, createDeepLink: ni, createShortLink: ri, pushAds: oi };
})(), r; })()));
